<template>
  <!-- Sidebar 内容 -->
  <aside
    class="h-full tablet:relative phone:absolute tablet:bg-transparent phone:bg-app-bg border-r border-layout-border transition-all ease-in-out duration-400 overflow-hidden z-50"
